			...
			<form action="" id="manage_survey">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						...
						<div class="form-group">
							<label for="" class="control-label">Title Acronym</label>
							<input type="text" name="acronym" class="form-control form-control-sm" required value="<?php echo isset($acronym) ? $acronym : '' ?>">
						</div>
						<div class="form-group">

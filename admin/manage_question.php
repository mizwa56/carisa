						      ...
						      <table width="100%" class="table">
						     	...
						     	<tbody>
						     		...
						     		<tr class="">
								      	...
								      	<td class="text-center">
								      		<input type="text" class="form-control form-control-sm check_inp"  name="label[]" value="<?php echo $v->label ?>">
								      	</td>
								      	<td class="text-center">
											<input type="number" name="point[]" class="form-control form-control-sm check_inp" value="<?php echo $v->points ?>">
										</td>
							     	</tr>
						     		<?php  endforeach; ?>
      ...
      <table width="100%" class="table">
     	...
     	<tbody>
     		<tr class="">
		      	...
		      	<td class="text-center">
				  <input type="number" name="point[]" class="form-control form-control-sm check_inp">
				</td>
	     	</tr>
	     	<tr class="">
		      	<td class="text-center">
...
<script>
	function new_check(_this){
		...
		var opt = '';
			...
			opt +='<td class="text-center"><input type="number" name="point[]" class="form-control form-control-sm check_inp"><a href="javascript:void(0)" onclick="$(this).closest(\'tr\').remove()"><span class="fa fa-times" ></span></a></td>';
		var tr = $('<tr></tr>')
		tr.append(opt)
		tbody.append(tr)
	}
